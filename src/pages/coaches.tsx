...
const Coaches = () => {
  return (
    <>
      <Seo title="Coaches | Power House Brasil" description="Conheça os coaches da Power House Brasil." />
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Coaches</h1>
